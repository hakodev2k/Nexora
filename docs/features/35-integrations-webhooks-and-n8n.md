...
> **Current decision amendment — 2026-09-07:** Paused by Product Owner; no connector/webhook/n8n execution. Foundational email/push delivery is not this paused user module. [Normative PO decisions](../requirements/10-owner-decisions-20260907.md). Conflicting older proposal paragraphs below are historical; current field/action overrides are in the linked delta. Docs-only.
