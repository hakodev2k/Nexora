...
> **Current decision amendment — 2026-09-09:** Product Owner approved the implementation-readiness recommendations in [DEC-20260909](../requirements/11-owner-decisions-20260909-implementation-readiness.md), then approved full local Release 1 implementation in [DEC-20260909-014](../requirements/12-owner-decisions-local-e2e-implementation.md). DEC-014 supersedes the older M01-only/future-slice implementation boundary: a slice may proceed when its API/DB/UX/acceptance/security/evidence contract is sufficient. Account restore/email reuse, TOTP recovery policy, sensitive projections, Vault hybrid recovery, initial Finance/Task boundaries, read-only outbound boundaries and production sequencing remain governed by their current decisions. Historical conflicting paragraphs remain evidence, not active implementation input.
...
| Planner/Goals/Habits/TimeTracking/Pomodoro | [Daily và Weekly Planner](15-planner.md), [Goals và Targets](16-goals.md), [Habit Tracker](17-habits.md), [Time Tracking](18-time-tracking.md), [Pomodoro và Focus](19-pomodoro.md) | Feature specs exist; a local slice may proceed when its contract is complete; unresolved product extensions remain gated |
| Documents types/Files/Bookmarks/Snippets/Folders/Page hierarchy/Collections/Tags | [Files, Uploads và Attachments](07-files-and-attachments.md), [Documents, Note và Knowledge Pages](20-documents.md), [Bookmarks](21-bookmarks.md), [Code Snippets](22-snippets.md), [Tags, Collections và Templates](24-organization-and-templates.md) | Feature specs exist; a local slice may proceed when its contract is complete; unresolved extensions remain gated |
...
| Global Search | [Search, Saved Search, Favorites và Command Palette](25-search-favorites-and-command-palette.md) | FX25-S01 Search + FX25-S03 typed Favorites implemented locally; remaining discovery actions contract-gated; owner projection gates apply |
| Advanced/SavedSearch/Favorites/Recent/History/CommandPalette | [Search, Saved Search, Favorites và Command Palette](25-search-favorites-and-command-palette.md) | Typed Favorites implemented locally; Recents/Saved Search/Command Palette/index remain gated |
| Dashboard/Home/Widgets/QuickActions | [Dashboard và Widgets](26-dashboard.md) | FX26-S01 read-only attention slice implemented locally; layout/widget mutation/quick actions remain gated |
...
| Wishlist/Compare/Orders/Purchases/Seller/Warranty | [Wishlist, Comparison, Orders, Sellers và Warranty](31-shopping-records.md) | Feature specs exist; a local slice may proceed when its contract is complete; sensitive projection policy applies |
| Developer Toolbox | [Developer Toolbox](32-developer-toolbox.md) | FX32 pure local tool subset implemented; advanced/history/network tools require separate contract/guard |
| GitHub New/Weekly/Detail | [GitHub Discovery](33-github-discovery.md) | Read-only public outbound allowed after guard contract; local implementation may proceed after that contract; real provider execution remains disabled |
| GitHub filters/snapshots/history | [GitHub Discovery](33-github-discovery.md) | Feature specs exist; a local slice may proceed when its contract and outbound guard are complete |
...
| PersonalAssets/Devices/Purchase/Warranty/Invoices/Accessories | [Personal Assets, Inventory và Devices](37-personal-assets.md) | Feature specs exist; a local slice may proceed when its contract is complete; sensitive projection policy applies |
| DigitalAssets/Domains/Hosting/VPS/Certs/Services/Licenses | [Monitoring và Job Operations](36-monitoring-and-job-operations.md), [Domains, Hosting, VPS, Certificates, Licenses và Services](38-digital-assets.md) | Metadata slice may proceed when provider/outbound contract is complete; sensitive projection policy applies |
| Career/Learning/Jobs/Companies/Interviews/Resumes/Skills/Courses/Certifications/WorkLog | [Career, Companies, Interviews và Resumes](39-career-and-resumes.md), [Skills, Courses, Certifications, Learning Plan và Work Log](40-learning-and-work-log.md) | Feature specs exist; a local slice may proceed when its contract is complete; DOCX/MD/internal Calendar and sensitive projection policies apply |
...
- **Approved for implementation:** DEC-20260909-014 permits contract-complete Release 1 local slices beyond M01. This does not approve production, real providers/secrets/data, paid services or external destructive actions.
