...
- `DEC-PRD-004`, `DEC-KNW-001..031`, `DEC-KNW-033..035`, `DEC-KNW-037..042` đã Approved; `DEC-PRD-005`, `DEC-KNW-032/036/043`, `DEC-TEC-006/007` và `DEC-SEC-006` phải đóng cho scope P0.
