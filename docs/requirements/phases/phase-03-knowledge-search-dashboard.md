...
| `P03-DOC-036` | P0 | Khi owner mở parent page, child pages được truy cập từ sidebar của page. | Mở child không đổi ParentPageId/FolderId hoặc content; sidebar không phải một Tree View mới của trang Documents và không tự cấp quyền cho share viewer. Archive cả cây theo `DEC-KNW-040`; cách hiển thị sidebar khi parent/child Archived còn mở tại `DEC-KNW-042`. |
...
- `DEC-PRD-004`, `DEC-KNW-001..031`, `DEC-KNW-033..035`, `DEC-KNW-037..041` đã Approved; `DEC-PRD-005`, `DEC-KNW-032/036/042`, `DEC-TEC-006/007` và `DEC-SEC-006` phải đóng cho scope P0.
