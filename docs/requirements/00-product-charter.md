...
**Version:** `1.0-draft`  
**Status:** Chờ Product Owner review  
**Last updated:** `2026-09-04`

## 1. Tầm nhìn

Nexora là một **multi-user Super Website** hợp nhất các công cụ, thông tin và workflow thường ngày trong một web application duy nhất. Sản phẩm được thiết kế như một nền tảng có module: mỗi module giải quyết một domain cụ thể nhưng tái sử dụng chung identity, ownership, permissions, sharing, notification, search, audit, file và background processing.
...
Người dùng cuối quản lý dữ liệu cá nhân, sử dụng module được bật, chia sẻ resource được phép chia sẻ và cấu hình preference của chính mình.
...
| `OUT-004` | Real-time multi-author document editing | Sharing hiện tại là read-only. |
...
| 1 | Có application shell multi-user an toàn và platform services tối thiểu. |
| 2 | User quản lý công việc, dự án, lịch và nhắc việc. |
| 3 | User lưu tri thức/tài liệu và tìm kiếm xuyên module; dashboard có giá trị thực tế. |
