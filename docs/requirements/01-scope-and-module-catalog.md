...
| Documents | Documents module với page types `Document`, `Note`, `Knowledge`; Files, Bookmarks, Snippets, Folders, Page hierarchy, Collections, Tags | Committed | 3 |
| Documents | Templates, Versioning, Archive, Read Later | Committed | 3 |
