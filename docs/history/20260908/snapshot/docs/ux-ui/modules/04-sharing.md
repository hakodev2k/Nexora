...
> **Current decision amendment — 2026-09-07:** Sharing off/source delete removes old links permanently; no re-enable/restore revival. Sensitive field scope remains partial. [Normative PO decisions](../../requirements/10-owner-decisions-20260907.md). Conflicting older proposal paragraphs below are historical; current field/action overrides are in the linked delta. Docs-only.
