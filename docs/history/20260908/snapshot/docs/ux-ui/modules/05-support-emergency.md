...
> **Current decision amendment — 2026-09-07:** Vault recovery is a separate SuperAdmin-only RECOVERY workflow, not Support/Emergency read access. [Normative PO decisions](../../requirements/10-owner-decisions-20260907.md). Conflicting older proposal paragraphs below are historical; current field/action overrides are in the linked delta. Docs-only.
