...
**Refinement 2026-09-06 — RM09 Documents:** đã chốt listing/search/filter theo nội dung trực tiếp tại vị trí mở và Archive parent kéo theo toàn bộ child pages (`DEC-KNW-039/040`, `P03-DOC-038..040`). Đợt phỏng vấn tiếp theo đã chốt Unarchive theo cùng đợt Archive, cho Archive riêng child khi parent Draft/Published và chặn Unarchive riêng child khi parent Archived (`DEC-KNW-041`, `P03-DOC-041..043`). Đã chốt sidebar giữ child Archived có nhãn/read-only, Archived liệt kê riêng từng page và Delete trực tiếp từ Archived (`DEC-KNW-042`, `P03-DOC-036/037/044`). Trash retention và tương tác child Trash/restore đã Resolved (delegated) tại `DEC-KNW-043`, `P03-DOC-045..047`; chưa đạt sign-off toàn bộ Documents. Thứ tự milestone và scope Release 1 không đổi.

**Cách refinement từ 2026-09-06:** theo `DEC-GOV-001`, PM/Technical tự hoàn thiện chi tiết UX/validation/lifecycle trong phạm vi đã duyệt, tham khảo nguồn chính thức và ghi rationale/AC. Product Owner chỉ được hỏi quyết định làm thay đổi đáng kể scope, workflow chính, quyền/privacy, chi phí hoặc nguy cơ mất dữ liệu. Open backlog phải phân loại lại theo mức quyết định; không biến mỗi edge case thành câu hỏi. Blueprint vẫn cần approval trước implementation.
