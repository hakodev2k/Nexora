...
| FX-25 | [Search, Saved Search, Favorites và Command Palette](../features/25-search-favorites-and-command-palette.md) | FX25-S01 owner-only source-query search implemented locally; saved/favorite/command gates apply | Not in M01 |
