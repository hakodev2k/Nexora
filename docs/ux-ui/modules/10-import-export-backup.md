...
## 1. Scope
Translate the current FX-10 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/10-import-export-and-backup.md`
...
- Separate user import/export from system backup.
- Preview→validation report→commit.
- Long operations have status/progress.
- Backup/restore is Admin operational flow.
