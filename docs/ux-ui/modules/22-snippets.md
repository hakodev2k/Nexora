...
## 1. Scope
Translate the current FX-22 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/22-snippets.md`
...
- Fast search/language filtering/Copy.
- Monospace escaped content.
- Copy feedback is explicit.
