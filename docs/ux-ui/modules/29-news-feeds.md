...
## 1. Scope
Translate the current FX-29 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/29-news-and-feeds.md`
...
- Desktop source/list/reader; mobile stack.
- Read state obvious.
- Feed error/stale shown at source level.
- Ingestion mechanism remains product decision.
...
Desktop may use Sources | Article list | Reader. Sources show unread count and health. Article row shows source, headline, published time, read and saved state.

Reader sanitizes content and keeps Open original visible.

Source health: Fresh / Stale / Fetch failed / Disabled with last successful refresh.