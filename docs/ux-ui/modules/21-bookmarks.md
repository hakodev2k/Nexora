...
## 1. Scope
Translate the current FX-21 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/21-bookmarks.md`
...
- Collection-scoped browse/search/filter.
- Grid/List reuse global patterns.
- Add flow previews extracted metadata before Save.
- Broken source is health state, not deletion.
