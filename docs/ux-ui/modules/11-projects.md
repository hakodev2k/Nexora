...
## 1. Scope
Translate the current FX-11 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/11-projects.md`
...
- Card shows Title/Start/End/Status.
- Project detail opens Tasks Kanban.
- Complete/Skip explains terminal consequences.
- All-terminal Tasks prompt but never auto-complete Project.
...
Projects Grid header: Search · Filters · Grid/Table · + New Project. Card shows Title, Start–End and Status; optional Priority/Tag only when present.

Project Detail tabs: Tasks | Overview | Activity. Tasks opens first.

Complete/Skip: terminal consequence is explicit. Complete with unfinished Tasks previews count and requires reason. Terminal success immediately shows a read-only banner.

Mobile: one-column project list; Task board may switch to status tabs instead of forcing four columns.