...
## 1. Scope
Translate the current FX-18 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/18-time-tracking.md`
...
- Running timer is prominent and stoppable.
- Recent entries are chronological.
- Reports use presets/custom range.
- Reject team billing/workspace complexity.
