...
## 1. Scope
Translate the current FX-16 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/16-goals.md`
...
- Cards emphasize progress/target.
- Detail shows definition/period/history.
- Formula models remain delegated/proposed unless approved.
- Charts include text values.
