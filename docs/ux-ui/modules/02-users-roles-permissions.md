...
## 1. Scope
Translate the current FX-02 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/02-users-roles-and-permissions.md`
...
- Admin-only dense table.
- Privilege edits show before→after diff.
- Last-SuperAdmin protection is explained proactively.
- Personal user content is not browsable here.
