...
## 1. Scope
Translate the current FX-35 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/35-integrations-webhooks-and-n8n.md`
...
- Use VaultRef instead of plaintext integration secrets.
- Webhook delivery history avoids secret replay.
- Outbound data preview shows what leaves Nexora.
- n8n remains optional boundary, not core DB access.
