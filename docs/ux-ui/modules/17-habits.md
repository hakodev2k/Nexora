...
## 1. Scope
Translate the current FX-17 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/17-habits.md`
...
- Today optimizes quick check-in.
- Detail shows schedule/streak/history without social feed.
- Boolean/count schedules only where source supports.
