...
## 1. Scope
Translate the current FX-39 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/39-career-and-resumes.md`
...
- Kanban for approved active stages; terminal outcomes can collapse.
- Detail tabs Overview/Activity/Interviews/Resume/Files.
- Record exact resume version used.
- Interview↔Calendar remains Q-12.
...
Job card: Company, Role, stage, next important date. Avoid long descriptions on cards.

Job Detail tabs: Overview | Activity | Interviews | Resume | Files.

Interview shows time, format/location/link, notes and calendar-link state; ownership/sync remains Proposed.

Resume Library shows name, version/update date and usage count. Sharing is explicit and read-only.