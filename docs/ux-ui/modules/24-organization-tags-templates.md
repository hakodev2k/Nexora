...
## 1. Scope
Translate the current FX-24 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/24-organization-and-templates.md`
...
- Tags lightweight; folders/collections explicit structure.
- Rename/delete previews counts.
- Template application cannot bypass immutable fields/lifecycle.
- Reuse shared search/filter patterns.
