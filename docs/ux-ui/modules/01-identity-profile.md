...
## 1. Scope
Translate the current FX-01 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/01-identity-and-profile.md`
...
- Registration presents Pending Verification; do not imply full module access before activation.
- Verification success moves into the authenticated personal experience.
- Security separates password, MFA/recovery and sessions.
- Account deletion entry remains visible but Q-01 owns final flow.
