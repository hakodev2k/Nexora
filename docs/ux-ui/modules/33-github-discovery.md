...
## 1. Scope
Translate the current FX-33 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/33-github-discovery.md`
...
- Ranked feed with repo/description/language/stars/forks/freshness.
- Open/Copy repository and clone URL.
- No Star/Fork/Issue mutations without approved write scope.
- Not a GitHub UI clone.
