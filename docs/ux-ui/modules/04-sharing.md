...
## 1. Scope
Translate the current FX-04 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/04-read-only-sharing.md`
...
- Familiar share dialog adapted to PublicLink/AuthenticatedLink/RestrictedUsers.
- Every share surface says Read-only.
- Preview safe projection for sensitive modules.
- Expired/revoked/unauthorized states are distinct.
