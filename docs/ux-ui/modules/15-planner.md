...
## 1. Scope
Translate the current FX-15 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/15-planner.md`
...
- Planner is a lens over Tasks/Calendar, not duplicate storage.
- Daily view prioritizes overdue/upcoming/unscheduled.
- Weekly view must not hard-code Monday before Q-09.
- Planning changes scheduling only, never duplicates Task.
