...
## 1. Scope
Translate the current FX-25 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/25-search-favorites-and-command-palette.md`
...
- One global keyboard entry.
- Recent items before typing.
- Destructive palette actions still confirm.
- Vault payload excluded.
