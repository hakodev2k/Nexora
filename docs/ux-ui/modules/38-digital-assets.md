...
## 1. Scope
Translate the current FX-38 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/38-digital-assets.md`
...
- Metadata tracker, not infrastructure control plane.
- List prioritizes type/provider/expiry/status/VaultRef indicator.
- Credentials route to Vault.
- Automation/network remains bounded by Q-07.
...
## 7. Screen inventory
- 01 — Digital Asset Table
- 02 — Domain/License/Hosting Detail
- 03 — Renewal Timeline
