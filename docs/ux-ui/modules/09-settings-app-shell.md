...
## 1. Scope
Translate the current FX-09 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/09-settings-and-app-shell.md`
...
- Stable settings sub-navigation.
- Appearance groups System/Light/Dark.
- Timezone IANA-aware; locale remains Q-09.
- Module settings registered only by enabled modules.
