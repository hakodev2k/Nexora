...
## 1. Scope
Translate the current FX-07 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/07-files-and-attachments.md`
...
- Upload progress/validation/scanning.
- Quarantine differs from ordinary failure.
- Only safe preview formats.
- Replace does not silently break history.
