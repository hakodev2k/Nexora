...
## 1. Scope
Translate the current FX-31 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/31-shopping-records.md`
...
- AnyList
- Personal order trackers

## 4. Reference behavior analysis
- Separate wish/compare from purchased history.
- Comparison aligns differing attributes.
- Purchase→Asset is explicit, never automatic.
- Sensitive share projection remains Q-03.
