...
## 1. Scope
Translate the current FX-08 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/08-trash-activity-and-audit.md`
...
- Trash is dedicated recoverable destination.
- Restore explains dependency/provenance conflicts.
- Permanent delete stronger than Trash.
- Audit avoids protected payload.
