...
## 1. Scope
Translate the current FX-32 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/32-developer-toolbox.md`
...
- Searchable category catalog.
- Split Input/Output desktop, stacked mobile.
- Consistent Copy/Download/Clear.
- Never execute untrusted input; network tools gated.
