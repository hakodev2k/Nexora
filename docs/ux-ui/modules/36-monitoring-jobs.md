...
## 1. Scope
Translate the current FX-36 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/36-monitoring-and-job-operations.md`
...
- Separate user monitoring from Admin jobs.
- Show health/last check/recent incidents.
- Job detail shows attempts/safe error/correlation/retry eligibility.
- Network/retention/capacity remain gated.
