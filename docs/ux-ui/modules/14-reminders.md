...
## 1. Scope
Translate the current FX-14 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/14-reminders-and-scheduling.md`
...
- Reminder is embedded in owning resource where possible.
- Exact datetime and approved 15-min-before shortcut.
- Do not imply unlimited reminders.
- Dispatched state is not proof user saw notification.
