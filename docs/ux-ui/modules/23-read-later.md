...
## 1. Scope
Translate the current FX-23 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/23-read-later.md`
...
- Queue emphasizes reading state.
- Reader sanitizes and preserves original link.
- Read/archive reversible where lifecycle allows.
- Parse failure is degraded content, not empty.
