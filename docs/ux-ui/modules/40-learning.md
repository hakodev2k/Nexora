...
## 1. Scope
Translate the current FX-40 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/40-learning-and-work-log.md`
...
- Moodle
- Coursera
- Personal learning trackers

## 4. Reference behavior analysis
- Dashboard emphasizes active plan/next action.
- Lists show explicit progress/status/dates.
- Avoid gamification scope creep.
- Detailed field/state/lifecycle remains discovery-dependent.
