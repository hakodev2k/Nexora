...
## 1. Scope
Translate the current FX-06 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/06-notification-center.md`
...
- Unread/All and source filters.
- Keyboard traversal on desktop.
- Three channels are attempts of one intent.
- Browser/provider failure is truthful delivery state.
