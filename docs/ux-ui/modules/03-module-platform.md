...
## 1. Scope
Translate the current FX-03 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/03-module-platform.md`
...
- Separate installed/system-enabled/user-enabled states.
- Disable preserves data but removes nav/search/widgets.
- Dependency failure is degraded/error, not empty.
- No executable upload marketplace.
