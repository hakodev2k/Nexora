...
## 1. Scope
Translate the current FX-12 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/12-tasks.md`
...
- Kanban default inside Project.
- Card shows Title/Priority/Start/End/Overdue.
- Reverse transition reason occurs before commit.
- Task detail is large panel/full page.
- Completed/Skipped remains editable while Project active.
...
Kanban columns: Not Started | In Progress | Completed | Skipped. Every move has keyboard/menu alternative.

Task card omits full description/AC/reminder/history.

Task detail sections: Title/Status/Priority; Start/End/Tags; Description; Acceptance Criteria; Reminder; History.

Overdue is a derived indicator, not a status column.

Mobile defaults to status tabs/segmented control rather than squeezed four-column board.