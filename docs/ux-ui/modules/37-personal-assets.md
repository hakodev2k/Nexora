...
## 1. Scope
Translate the current FX-37 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/37-personal-assets.md`
...
- Table primary for dense metadata.
- Detail tabs Overview/Purchase/Warranty/Repairs/Files/History.
- Lifecycle follows Nexora, not imported enterprise checkout model.
- Sensitive sharing/field lifecycle remain Q-dependent.
...
Asset Table prioritizes Name, Type, Status, safe identifier/serial, Purchase date and Warranty state.

Detail tabs: Overview | Purchase | Warranty | Repairs | Files | History.

Warranty/repair uses timeline rather than one giant form. Mobile uses compact rows and full-screen detail tabs.