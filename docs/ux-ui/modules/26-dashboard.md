...
## 1. Scope
Translate the current FX-26 feature behavior into a coherent Nexora UI. Reference products do not add scope automatically.

## 2. Requirement sources
- `docs/features/26-dashboard.md`
...
- Avoid enterprise BI density.
- Widgets fail independently.
- Exact default widget set/customization remains Proposed.
