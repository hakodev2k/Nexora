...
> Current specification · reconciled 2026-09-08 · Docs-only. [Previous version](../history/20260908/snapshot/docs/design-database/10-assets-career-learning.md) is historical evidence, not implementation input.
...
| [career.CalendarLink](#career-calendarlink) | Internal Job↔Personal Event reference | FX-39 | Current scope; technical dictionary |
...
## career.Interview — retired

No current table or workflow. Use [career.CalendarLink](#career-calendarlink). Historical columns preserved only in the snapshot; do not migrate this proposal.
...
**Integrity / transaction:** Sharing pins exact selected version, not latest automatic. DOCX/MD basic format contract with explicit fidelity preview; immutable uploaded-file version core retained.
